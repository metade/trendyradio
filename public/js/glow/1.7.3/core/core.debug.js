		...
		glow = {
			...
			*/
			...
			@param {String[]} meta.library Information about Glow.
				This must be ["glow", "1.7.3"]. 1.7.3 should be
				the version number of glow expected.

			@param {String[]} meta.depends The module's dependencies.
				This must start ["glow", "1.7.3"], followed by modules
				such as "glow.dom". 1.7.3 should be the version number
				of glow expected.
...
(window.gloader || glow).module({
	name: "glow.net",
	library: ["glow", "1.7.3"],
	depends: [["glow", "1.7.3", "glow.data", "glow.events"]],
	builder: function(glow) {
		//private
...
(window.gloader || glow).module({
	name: "glow.anim",
	library: ["glow", "1.7.3"],
	depends: [["glow", "1.7.3", "glow.tweens", "glow.events", "glow.dom"]],
	builder: function(glow) {
		//private
		var $ = glow.dom.get,
			manager,
...
(window.gloader || glow).module({
	name: "glow.forms",
	library: ["glow", "1.7.3"],
	depends: [["glow", "1.7.3", 'glow.dom', 'glow.events', 'glow.anim', 'glow.net', 'glow.i18n']],
	builder: function(glow) {
...
feedback.defaultFeedback = (function() {
	...
	function updateScreenReaderBuffer() {
		if (!screenReaderBufferUpdater) {
			screenReaderBufferUpdater = glow.dom.create('<input type="hidden" value="0" name="1.7.3" id="1.7.3" />').appendTo(document.body);
		}
...
(window.gloader || glow).module({
	name: "glow.embed",
	library: ["glow", "1.7.3"],
	depends: [["glow", "1.7.3", "glow.dom", "glow.data", "glow.i18n"]],
	builder: function(glow) {
...
(window.gloader || glow).module({
	name: "glow.dragdrop",
	library: ["glow", "1.7.3"],
	depends: [["glow", "1.7.3", "glow.tweens", "glow.events", "glow.dom", "glow.anim"]],
	builder: function(glow) {
